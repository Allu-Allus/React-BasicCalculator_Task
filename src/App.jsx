...
<div className="container d-flex justify-content-center align-items-center my-5">
  <div className="card shadow p-3 rounded-4 bg-dark w-100" style={{ maxWidth: "500px" }}>
    <div className="card-body">
      <h1 className='text-white text-center mb-4'>CALCULATOR</h1>
      ...
      <div className="row g-2 mb-2">
        ...
        <div className="col-3"><div onClick={() => display('9')} className="btn w-100 h-100 border shadow text-white fw-bold fs-5">9</div></div>
